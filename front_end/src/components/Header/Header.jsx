...
export const Header = () => {
  ...
  return (
    <div className="fixed z-50 top-0 left-0 right-0 h-[90px]  mx-auto flex items-center justify-between border-b border-white px-10 bg-[#F2F1EB] mb-[90px]">
        ...
        <ul className={`flex items-center gap-[60px] text-black montserrat-font duration-300 ease-in-out max-lg:flex-col max-lg:bg-white max-lg:text-black max-lg:w-[50%] max-sm:w-[80%] max-lg:fixed max-lg:pt-[100px] max-lg:top-0 ${isOpenNavbar ? 'max-lg:right-0' : 'max-lg:right-[-100%]'} max-lg:bottom-0 max-lg:border max-lg:z-50`}>
