...
import { fetchGetServiceById, fetchUpdateService } from "../../../../api/service.api";
import PropTypes from 'prop-types';

const UpdateServiceModel = ({setIsOpen, idTerm}) => {
    ...
    useEffect(() => {
      fetchGetServiceById(idTerm).then((res) => {
        setServiceState({
            name: res?.data.data.name || '',
            description: res?.data.data.description || '',
            priceBeforeDiscount: res?.data.data.priceBeforeDiscount || '',
