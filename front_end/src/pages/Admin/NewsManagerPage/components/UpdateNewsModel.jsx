...
import { fetchNewsById, fetchUpdateNews } from '../../../../api/news.api';
import { toast } from 'react-toastify';
const UpdateNewsModel = ({setIsOpen, idTerm}) => {
  ...
  const handleSubmit = (e) => {
      ...
      addServiceMutation.mutate({idTerm, formData}, {
          onSuccess: (res) => {
              if(res.status === 200) {
